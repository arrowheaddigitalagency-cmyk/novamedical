      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 tracking-tight">
            Fees &amp; <span className="text-[#e6704a]">Billing Policy</span>
          </h2>
          ...
          <div className="lg:col-span-7 bg-[#FFFBF9] p-6 sm:p-8 rounded-3xl border border-orange-100 shadow-soft space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {CLINIC_INFO.bulkBillingNotes.map((note, index) => (
                  ...
                  >
                    <CheckCircle2 className="w-5 h-5 text-[#e6704a] shrink-0 mt-0.5" />
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4 text-xs text-slate-600 border-t border-slate-200/80">
              <span className="flex items-center gap-1.5 font-semibold text-orange-900 bg-orange-50 px-3 py-1.5 rounded-lg border border-orange-100">
                <ShieldCheck className="w-4 h-4 text-[#e6704a]" />
          ...
          <div className="lg:col-span-5 bg-gradient-to-br from-slate-900 to-[#10182D] text-white p-6 sm:p-8 rounded-3xl shadow-xl space-y-6">
            ...
            <div className="bg-slate-800/80 p-4 rounded-2xl border border-slate-700/80 space-y-2 text-xs text-slate-300">
              <div className="flex justify-between items-center">
                ...
                <a
                  ...
                  className="font-bold text-[#e6704a] hover:underline"
                >
                  {CLINIC_INFO.phone}
                </a>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <a
                ...
                className="flex-1 py-3 px-4 bg-[#e6704a] hover:bg-[#c8552e] text-white font-bold rounded-xl text-sm transition-colors text-center flex items-center justify-center gap-2 whitespace-nowrap"
              >
